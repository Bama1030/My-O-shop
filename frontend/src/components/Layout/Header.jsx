...
import Logo from "../Image/Orange And Green Modern Online Shop Logo (1).png";
                    ...
                    <div>
                        <Link to="/">
                            <img
                                ...
                                className=' mt-0.2 cursor-pointer'
                            />
                        </Link>
                    </div>
                    <div>
                                ...
                                <div className=' flex w-full justify-center'>
                                    {
                                        isAuthenticated ? (
                                            <Link to="/profile">
                                                <div>
                                                    <img src={`${backend_url}${user.avatar}`} alt='' className=' w-[60px] h-[60px] rounded-full border-[2px] border-[#0eae88]' />
                                                </div>
                                            </Link>

                                        ) : (
                                            <>
                                                <Link to="/Login" className=' text-[18px] pr-[10px] text-[#000000cb]'>Login /</Link>
                                                <Link to="/sign-up" className=' text-[18px] text-[#000000cb]'>Sign up</Link>
                                            </>
                                        )
                                    }
                                </div>
